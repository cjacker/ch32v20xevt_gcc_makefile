...
#define USER_IMAGE_MAX_SIZE             0xB000

#define BACKUP_IMAGE_START_ADD          ((uint32_t) 0x08015000)
#define BACKUP_IMAGE_MAX_SIZE           0xB000
...
extern void receUpdatedFile(u8 socketid);
extern void IAPFileParaCheck(u8 socketid);
extern void IAP_EEPROM_ERASE_44k(u32 StartAddr);
