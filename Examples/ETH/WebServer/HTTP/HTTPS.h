...
#define PAGE_WRITE_START_ADDR     ((uint32_t)0x0801FC00) /* Start from 127K */
#define PAGE_WRITE_END_ADDR       ((uint32_t)0x08020000) /* End at 128K */
#define FLASH_PAGE_SIZE           256

#define BASIC_CFG_ADDR            ((uint32_t)0x0801FC00)
#define PORT_CFG_ADDR             ((uint32_t)0x0801FD00)
#define LOGIN_CFG_ADDR            ((uint32_t)0x0801FE00)
