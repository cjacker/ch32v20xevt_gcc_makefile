 ...
 * Version            : V1.0
 * Date               : 2018/12/12
 * Description        : Bluetooth touch application, initialize the broadcast connection 
 *                      parameters, and then broadcast until the host is connected, 
 *                      and upload the touch value regularly
 *********************************************************************************
