...
/******************************************************************************/
/* USBFS DEVICE USB_CONTROL */
/* BASE USB_CTRL */
#define   USBFS_BASE_CTRL       (USBFSD_FS->BASE_CTRL)  // USB base control
...
/* DEVICE USB_CTRL */
#define   USBFS_UDEV_CTRL        (USBFSD_FS->UDEV_CTRL)  // USB device physical prot control
...
/* USB INT EN */
#define   USBFS_INT_EN           (USBFSD_FS->INT_EN)    // USB interrupt enable
...
/* USB_DEV_ADDR */
#define   USBFS_DEV_ADDR         (USBFSD_FS->DEV_ADDR)   // USB device address
#define     USBFS_UDA_GP_BIT       0x80      // general purpose bit
#define     USBFS_USB_ADDR_MASK    0x7F      // bit mask for USB device address
/* USBFSD_FS DEVICE USB_STATUS */
/* USB_MIS_ST */
#define   USBFS_MIS_ST           (USBFSD_FS->MIS_ST)     // USB miscellaneous status
...
/* USB_INT_FG */
#define   USBFS_INT_FG           (USBFSD_FS->INT_FG)    // USB interrupt flag
...
/* USB_INT_ST */
#define   USBFS_INT_ST           (USBFSD_FS->INT_ST)    // USB interrupt flag
...
/* USB_RX_LEN */
#define   USBFS_RX_LEN        (USBFSD_FS->Rx_Len)      // USB receiving length
/* USB_BUF_MOD */
#define   USBFS_UEP4_1_MOD    (USBFSD_FS->UEP4_1_MOD)  // endpoint 4/1 mode
...
#define  USBFS_UEP2_3_MOD     (USBFSD_FS->UEP2_3_MOD)  // endpoint 2/3 mode
...
#define  USBFS_UEP5_6_MOD     (USBFSD_FS->UEP5_6_MOD)  // endpoint 5/6 mode
...
#define  USBFS_UEP7_MOD       (USBFSD_FS->UEP7_MOD)  // endpoint 7 mode
...
/* USB_DMA */
#define  USBFS_UEP0_DMA       (USBFSD_FS->UEP0_DMA) // endpoint 0 DMA buffer address
#define  USBFS_UEP1_DMA       (USBFSD_FS->UEP1_DMA) // endpoint 1 DMA buffer address
#define  USBFS_UEP2_DMA       (USBFSD_FS->UEP2_DMA) // endpoint 2 DMA buffer address
#define  USBFS_UEP3_DMA       (USBFSD_FS->UEP3_DMA) // endpoint 3 DMA buffer address
#define  USBFS_UEP4_DMA       (USBFSD_FS->UEP4_DMA) // endpoint 4 DMA buffer address
#define  USBFS_UEP5_DMA       (USBFSD_FS->UEP5_DMA) // endpoint 5 DMA buffer address
#define  USBFS_UEP6_DMA       (USBFSD_FS->UEP6_DMA) // endpoint 6 DMA buffer address
#define  USBFS_UEP7_DMA       (USBFSD_FS->UEP7_DMA) // endpoint 7 DMA buffer address
/* USB_EP_CTRL */
#define  USBFS_UEP0_T_LEN     (USBFSD_FS->UEP0_TX_LEN)   // endpoint 0 transmittal length
#define  USBFS_UEP0_TX_CTRL   (USBFSD_FS->UEP0_TX_CTRL)  // endpoint 0 control
#define  USBFS_UEP0_RX_CTRL   (USBFSD_FS->UEP0_RX_CTRL)  // endpoint 0 control

#define  USBFS_UEP1_T_LEN     (USBFSD_FS->UEP1_TX_LEN)   // endpoint 1 transmittal length
#define  USBFS_UEP1_TX_CTRL   (USBFSD_FS->UEP1_TX_CTRL)  // endpoint 1 control
#define  USBFS_UEP1_RX_CTRL   (USBFSD_FS->UEP1_RX_CTRL)  // endpoint 1 control

#define  USBFS_UEP2_T_LEN     (USBFSD_FS->UEP2_TX_LEN)   // endpoint 2 transmittal length
#define  USBFS_UEP2_TX_CTRL   (USBFSD_FS->UEP2_TX_CTRL)  // endpoint 2 control
#define  USBFS_UEP2_RX_CTRL   (USBFSD_FS->UEP2_RX_CTRL)  // endpoint 2 control

#define  USBFS_UEP3_T_LEN     (USBFSD_FS->UEP3_TX_LEN)   // endpoint 3 transmittal length
#define  USBFS_UEP3_TX_CTRL   (USBFSD_FS->UEP3_TX_CTRL)  // endpoint 3 control
#define  USBFS_UEP3_RX_CTRL   (USBFSD_FS->UEP3_RX_CTRL)  // endpoint 3 control

#define  USBFS_UEP4_T_LEN     (USBFSD_FS->UEP4_TX_LEN)   // endpoint 4 transmittal length
#define  USBFS_UEP4_TX_CTRL   (USBFSD_FS->UEP4_TX_CTRL)  // endpoint 4 control
#define  USBFS_UEP4_RX_CTRL   (USBFSD_FS->UEP4_RX_CTRL)  // endpoint 4 control

#define  USBFS_UEP5_T_LEN     (USBFSD_FS->UEP5_TX_LEN)   // endpoint 5 transmittal length
#define  USBFS_UEP5_TX_CTRL   (USBFSD_FS->UEP5_TX_CTRL)  // endpoint 5 control
#define  USBFS_UEP5_RX_CTRL   (USBFSD_FS->UEP5_RX_CTRL)  // endpoint 5 control

#define  USBFS_UEP6_T_LEN     (USBFSD_FS->UEP6_TX_LEN)   // endpoint 6 transmittal length
#define  USBFS_UEP6_TX_CTRL   (USBFSD_FS->UEP6_TX_CTRL)  // endpoint 6 control
#define  USBFS_UEP6_RX_CTRL   (USBFSD_FS->UEP6_RX_CTRL)  // endpoint 6 control

#define  USBFS_UEP7_T_LEN     (USBFSD_FS->UEP7_TX_LEN)   // endpoint 7 transmittal length
#define  USBFS_UEP7_TX_CTRL   (USBFSD_FS->UEP7_TX_CTRL)  // endpoint 7 control
#define  USBFS_UEP7_RX_CTRL   (USBFSD_FS->UEP7_RX_CTRL)  // endpoint 7 control
...
#ifdef  USBFS_HOST
/* USBFSD_FS HOST CONTROL&CFG */
/* HOST USB_CTRL */
#define  USBFS_UHOST_CTRL       (USBFSD_FS->UDEV_CTRL) // USB host physical prot control
...
#endif
#ifdef USB_OTG
#define  USB_OTG_CR          (USBFSD_FS->OTG_CR)  // usb otg control
...
#define  USB_OTG_SR          (USBFSD_FS->OTG_CR)  // usb otg status
